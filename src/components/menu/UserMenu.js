...
function UserMenu({ miniActive, avatar, language, changeLanguage }) {
  ...
  const displayName = email || "Some user"
  return (
    <div className={classes.user}>
      ...
      <List className={classes.list}>
        <ListItem className={classes.item + ' ' + classes.userItem}>
          <NavLink to={'/'} className={classes.itemLink + ' ' + classes.userCollapseButton} onClick={openCollapseAvatar}>
            <ListItemText
              primary={displayName}
              ...
              <Tooltip disableHoverListener={!miniActive} title={t('MyProfile')}>
                <ListItem className={classes.collapseItem}>
                  <NavLink to='/myProfile' className={classes.itemLink}>
                    ...
                    <ListItemText primary={t('MyProfile')} disableTypography={true} className={itemText} />
                  </NavLink>
                </ListItem>
              </Tooltip>             
              <ListItem className={classes.selectorItem}>
                <LanguageSelector language={language} changeLanguage={changeLanguage} miniActive={miniActive} />
              </ListItem>
            </List>
          </Collapse>
        </ListItem>
